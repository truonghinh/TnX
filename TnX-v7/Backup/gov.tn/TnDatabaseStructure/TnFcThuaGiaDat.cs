...
{
    public class TnFcThuaGiaDat : TnGeoDatabaseObject
    {
        private static TnFcThuaGiaDat meClass = null;
        ...
        public static TnFcThuaGiaDat GetMe(IWorkspace workspace)
        {
            if (meClass == null)
            {
                meClass = new TnFcThuaGiaDat(workspace);
            }
            return meClass;
        }
        private TnFcThuaGiaDat(IWorkspace workspace)
            : base(workspace)
        {
