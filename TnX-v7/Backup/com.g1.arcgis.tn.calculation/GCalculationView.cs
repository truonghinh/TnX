...
{
    public partial class GCalculationView : DevExpress.XtraEditors.XtraUserControl, ICalculationView, IReceiverView, IDatabaseInteractive
    {
        //dung de tinh gia dat
        #region tinh gia dat
        protected IInputParams _inputParams;
        protected ICurrentConfig _currentConfig;
        protected ICalculation _calc;
        protected ICalculationView _calcView;
        protected ICalculationController _calcController;
        protected ICalculationMonitor _monitor;
        protected List<ICalculationMonitor> _lstMonitor;

        #endregion

        //dung de load du lieu
        protected ILoader _loader;
        protected ILoaderController _loaderController;
        protected string _sql = "";
        protected IDictionary<EnumG1ArcGisTnRecType, string> _dicSql;
        protected IDictionary<EnumG1ArcGisTnRecType, string> _dicTableName;
        protected IDictionary<EnumG1ArcGisTnRecType, string> _dicColsName;
        protected IDictionary<EnumG1ArcGisTnRecType, string> _dicColsNameInWhereClause;
        protected ITnFeatureClassName _fcName;
        protected ITnTableName _tblName;
        protected static XPair _lstXa;
        protected static XPair _lstDuong;
        protected static XPair _lstDoanDuong;
