...
{
    public class CalcGiaHemPhu100_200 : Calculator, ICalculator
    {
        private string vitri = "";
        private int _isDothi = 1;
        private string vitiHem = "2";
        public CalcGiaHemPhu100_200()
            : base()
        {
                    ...
                    while ((duongId = eIds.Next()) != -1)
                    {
                        ...
                        try
                        {
                            while ((gdhChinhFt = gdhChinhFc.NextFeature()) != null)
                            {
                                ...
                                _clipTool.ClipByLayerFileInsideSde(hemChinhFeatureLayer, hemlyr, hemBuff200FeatureLayer, duonglyr, hemClip200mNoSde);
                                try
                                {
