...
{
    public class CalcPosTHCS100_200TronThua : Calculator, ICalculator
    {
        //!!!!tim cum tu [thaydoi] de biet cho thay doi giua cac may tinh
        //cum tu nay duoc dat truoc moi region
        private string vitri = "trong hẻm chính, 100m<sâu<200m";
        private int _isDothi = 1;
        public CalcPosTHCS100_200TronThua()
            : base()
        {
        ...
        protected override void calculate()
        {
            ...
            IFeatureLayer hemFeatureLayer = new FeatureLayerClass();
            hemFeatureLayer.FeatureClass = hemFeatureClass;
            IFeatureSelection hemFeatureSelection;
            //_fcName.FC_DUONG.InitIndex();
            #endregion
            ...
            #region log---
            evt.Log = string.Format("\n----Lấy các quy tắc tìm vị trí thửa từ bảng {0}, ứng với hệ số {1} ...", DataNameTemplate.He_So_K, TnHeSoK.DatOHemChinhR6mS100_200mTronThua);
            onCalculating(evt);
            #endregion

            qrf.WhereClause = string.Format("{0}='{1}'", "hesovitri", TnHeSoK.DatOHemChinhR6mS100_200mTronThua);
            ...
            if (this._inputParams.MA_XA != "-1")
            {
                ...
                while ((xaId = xaIds.Next()) != -1)
                {
                    ...
                    while ((duongId = eIds.Next()) != -1)
                    {
                        ...
                        hemFeatureSelection = (IFeatureSelection)hemFeatureLayer;
                        hemFeatureSelection.SelectionSet = hemSelectionSet;
                        #endregion
                        //====================
                        ...
                        while ((hemId = eIdsHem.Next()) != -1)
                        {
                            ...
                            eval.HemChinhLayer = hemFeatureLayer;
                            eval.EvaluateQuery();
                            //thuaFeatureSelection = (IFeatureSelection)thuaFeatureLayer;
                            ...
                            {
                                int hesoVitri = TnHeSoK.DatOHemChinhR6mS100_200mTronThua;
                                ...
                                if (chicodato)
                                {
                                    if (dorong > 6)
                                    {
                                        hesoVitri = TnHeSoK.DatOHemChinhR3mS100_200mTronThua;
                                    }
                                    else if (dorong < 3.5)
                                    {
                                        hesoVitri = TnHeSoK.DatOHemChinhR3mS100_200mTronThua;
                                    ...
                                    {
                                        hesoVitri = TnHeSoK.DatOHemChinhR3_6mS100_200mTronThua;
                                    }
                                }
                                else if (chicodatsxkd)
                                {
                                    if (dorong > 6)
                                    {
                                        hesoVitri = TnHeSoK.DatSxkdHemChinhR6mS100_200mTronThua;
                                    }
                                    else if (dorong < 3.5)
                                    {
                                        hesoVitri = TnHeSoK.DatSxkdHemChinhR3mS100_200mTronThua;
                                    }
                                    else
                                    {
                                        hesoVitri = TnHeSoK.DatSxkdHemChinhR3_6mS100_200mTronThua;
                                    }
                                }
                                else if (dathonhop && codato && datnn)
                                {
                                    if (dorong > 6)
                                    {
                                        hesoVitri = TnHeSoK.DatONnHemChinhR6mS100_200mTronThua;
                                    }
                                    else if (dorong < 3.5)
                                    {
                                        hesoVitri = TnHeSoK.DatONnHemChinhR3mS100_200mTronThua;
                                    }
                                    else
                                    {
                                        hesoVitri = TnHeSoK.DatONnHemChinhR3_6mS100_200mTronThua;
                                    }
                                }
                                else
                                {
                    ...
                    while ((hemId = eIdsHem.Next()) != -1)
                    {
                        ...
                        while ((thuaId = thuaIds.Next()) != -1)
                        {
                            ...
                            if (chicodato)
                            {
                                if (dorong > 6)
                                {
                                    hesoVitri = TnHeSoK.DatOHemChinhR6mS100_200mTronThua;
                                }
                                else if (dorong < 3.5)
                                {
                                    hesoVitri = TnHeSoK.DatOHemChinhR3mS100_200mTronThua;
