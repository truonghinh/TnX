...
{
    public class CalcPosTHCS100KoTronThua : Calculator, ICalculator
    {
       //!!!!tim cum tu [thaydoi] de biet cho thay doi giua cac may tinh
        //cum tu nay duoc dat truoc moi region
        private string vitri = "trong hẻm chính, sâu < 100m (không trọn thửa)";
        private int _isDothi = 1;
        public CalcPosTHCS100KoTronThua()
            : base()
        {
