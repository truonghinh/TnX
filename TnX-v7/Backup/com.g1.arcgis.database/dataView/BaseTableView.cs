...
{
    public partial class BaseTableView : DevExpress.XtraEditors.XtraUserControl, IAttributeQueryView, IEditTableView
    {
        ...
        private void grvAttributeTable_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            if (e.Button == MouseButtons.Right)
            {
                ...
                grcAttributeTable.ContextMenu.Show(grcAttributeTable, new System.Drawing.Point(e.X, e.Y));
            }
        ...
        void IAttributeQueryView.SetDetailView(com.g1.arcgis.landprice.ILandpriceView calcView, com.g1.arcgis.landprice.ILandpriceView publicView)
        {
            throw new NotImplementedException();
        }
