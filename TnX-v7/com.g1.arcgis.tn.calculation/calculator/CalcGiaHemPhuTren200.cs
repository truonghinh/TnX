...
{
    public class CalcGiaHemPhuTren200 : Calculator, ICalculator
    {
        private string vitri = "";
        private int _isDothi = 1;
        private string vitiHem = "3";
        public CalcGiaHemPhuTren200()
            : base()
        {
        ...
        protected override void calculate()
        {
            ...
            hemPhuFeatureLayer.FeatureClass = hemPhuFeatureClass;
            ...
            {
                _bufferTool.BufferInsideSde(gdhChinhFeatureClass.AliasName, hemBuffer200mNoSde, 200);
            }
            ...
            if (this._inputParams.MA_XA != "-1")
            {
                ...
                while ((xaId = xaIds.Next()) != -1)
                {
                    ...
                    while ((duongId = eIds.Next()) != -1)
                    {
                        ...
                        qrf.WhereClause = string.Format("{0}='{1}'", _fcName.FC_GIA_DAT_HEM.MA_DUONG, maduong);
                        IFeatureCursor gdhChinhFc = gdhChinhFeatureClass.Search(qrf, false);
                        IFeature gdhChinhFt = null;
                        //MessageBox.Show("line 972, qrf=" + qrf.WhereClause);
                        try
                        {
                            while ((gdhChinhFt = gdhChinhFc.NextFeature()) != null)
                            {
                                ...
                                ISelectionSet hemPhuSelectionSet = hemPhuFeatureClass.Select(qrf, esriSelectionType.esriSelectionTypeHybrid, esriSelectionOption.esriSelectionOptionNormal, sdeConn.Workspace);
                                hemPhuFeatureSelection = (IFeatureSelection)hemPhuFeatureLayer;
                                hemPhuFeatureSelection.SelectionSet = hemPhuSelectionSet;
                                //MessageBox.Show(string.Format("line 990,sls={0},mahemchinh={1}", hemPhuSelectionSet.Count, maHemChinh));
                                #endregion
                                ...
                                #region chon hem buffer 200 dang xet
                                ...
                                #region log---
                                evt.Log = string.Format("\n----Kiểm tra, clip hẻm theo đường buffer {0}m, lưu vào bảng {1} ...", 200, hemErase200mCoSde);
                                onCalculating(evt);
                                #endregion
                                ...
                                //_clipTool.ClipByLayerFileInsideSde(hemChinhFeatureLayer, hemlyr, hemBuff200FeatureLayer, duonglyr, hemErase200mNoSde);
                                //try
                                //{
                                ...
                                #region erase phan hem tren 200m
                                ...
                                string hemErlyr = string.Format("{0}/{1}", _sysTempPath.TempPath, hemErase200mNoSde);
                                string duongErlyr = string.Format("{0}/{1}", _sysTempPath.TempPath, hemBuffer200mNoSde);
                                _eraseTool.EraseByLayerFileInsideSde(hemPhuFeatureLayer, hemlyr, hemBuff200FeatureLayer, duonglyr, hemErase200mNoSde);
                                #endregion

                                try
                                {
                                    hemErFc = fw.OpenFeatureClass(hemErase200mCoSde);
                                }
                                ...
                                while ((hemPhuId = hemPhuIds.Next()) != -1)
                                {
                                    ...
                                    hemPhuFt = hemPhuFeatureClass.GetFeature(hemPhuId);
                                    //hemErId = hemErFt.OID;
                                    ...
                                    //MessageBox.Show("line 1146 qrf=" + qrf.WhereClause);
                                    ...
                                    try
                                    {
                                        ...
                                        if (gdhPhuFt != null)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                IFeatureCursor hemErFcur = hemErFc.Search(qrf, false);
            ...
            else
            {
                ...
                ISelectionSet duongSelectionSet = duongFeatureClass.Select(qrf, esriSelectionType.esriSelectionTypeHybrid, esriSelectionOption.esriSelectionOptionNormal, sdeConn.Workspace);
                //MessageBox.Show(string.Format("line 912,sls={0}",duongSelectionSet.Count));
