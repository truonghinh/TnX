...
{
    public class CalcPosThuaMatTienTronThua:Calculator,ICalculator
    {
        ...
        public CalcPosThuaMatTienTronThua()
            : base()
        {
        ...
        protected override void calculate()
        {
            ...
            if (this._inputParams.MA_XA != "-1")
            {
                ...
                while ((xaId = xaIds.Next()) != -1)
                {
                    ...
                    #endregion
                    //MessageBox.Show("line 260 CalcPosThuaMatTien,loaidothi=" + loaidothi.ToString());
                    if (loaidothi == 0)
                    {
                        //MessageBox.Show("line 263 CalcPosThuaMatTien,loaidothi=" + loaidothi.ToString());
                        continue;
                    }
                    //continue;
                    #region -----log
                    ...
                    while ((duongId = eIds.Next()) != -1)
                    {
                        ...
                        {
                            int hesoVitri = TnHeSoK.DatOMtTtDt;
                            ...
                            if (chicodato)
                            {
                                hesoVitri = TnHeSoK.DatOMtTtDt;
                            }
                            else if (chicodatsxkd)
                            {
                                hesoVitri = TnHeSoK.DatSxkdMatTienTronThuaDt;
                            }
                            else if (dathonhop && codato && datnn)
                            {
                                hesoVitri = TnHeSoK.DatONnMatTienTronThuaDt;
                            }
            ...
            else
            {
                ...
                while ((duongId = eIds.Next()) != -1)
                {
                    ...
                    //MessageBox.Show(string.Format("line 1059 CalcMattien thuaselection={0}", thuaSelectionSet.Count));
                    #endregion
