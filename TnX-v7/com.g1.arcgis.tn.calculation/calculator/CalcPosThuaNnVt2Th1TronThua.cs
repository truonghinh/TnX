...
{
    public class CalcPosThuaNnVt2Th1TronThua : Calculator, ICalculator
    {
        //!!!!tim cum tu [thaydoi] de biet cho thay doi giua cac may tinh
        //cum tu nay duoc dat truoc moi region
        private string vitri = "2";
        private int _isDothi = 1;
        public CalcPosThuaNnVt2Th1TronThua()
            : base()
        {
        ...
        protected override void calculate()
        {
            ...
            #region log---
            evt.Log = string.Format("\n----Lấy các quy tắc tìm vị trí thửa từ bảng {0}, ứng với hệ số {1} ...", DataNameTemplate.He_So_K, TnHeSoK.DatNongNghiepVt2Th1);
            onCalculating(evt);
            #endregion

            qrf.WhereClause = string.Format("{0}='{1}'", "hesovitri", TnHeSoK.DatNongNghiepVt2Th1);
            ...
            if (this._inputParams.MA_XA != "-1")
            {
                ...
                while ((xaId = xaIds.Next()) != -1)
                {
                    ...
                    while ((duongId = eIds.Next()) != -1)
                    {
                        ...
                        if (dorongDuong > _currentConfig.DRongDuongVitri2NnMax || dorongDuong<_currentConfig.DRongDuongVitri2NnMin)
                        {
                            continue;
                        }
                        ...
                        {
                            int hesoVitri = TnHeSoK.DatNongNghiepVt2Th1;
                            ...
                            if (codatnn)
                            {
                                hesoVitri = TnHeSoK.DatNongNghiepVt2Th1;
                            }
                            else
                            {
