...
namespace MapControlAppPropertyPage
{
  ...
  /// </summary>
  public sealed class frmMain : System.Windows.Forms.Form
  {
    ...
    private static readonly frmMain meForm = new frmMain();
    //private class members
    private IMapControl3 m_mapControl = null;
    private string m_mapDocumentName = string.Empty;
    private StatusBarPanel statusBarXY;

    TocContextMenuClass m_tocContextMenu = null;
    ...
    private void InitializeComponent()
    {
      ...
      this.axMapControl1.Location = new System.Drawing.Point(209, 28);
      this.axMapControl1.Name = "axMapControl1";
      this.axMapControl1.OcxState = ((System.Windows.Forms.AxHost.State)(resources.GetObject("axMapControl1.OcxState")));
      this.axMapControl1.Size = new System.Drawing.Size(575, 484);
      ...
      // splitter1
      // 
      this.splitter1.Location = new System.Drawing.Point(209, 28);
    ...
    private void frmMain_Load(object sender, System.EventArgs e)
    {
      ...
      //((IDynamicMap)axMapControl1.Map).DynamicMapEnabled = true;
    }
    ...
    private void axMapControl1_OnMapReplaced(object sender, ESRI.ArcGIS.Controls.IMapControlEvents2_OnMapReplacedEvent e)
    {
      ...
      else
      {
        ...
        statusBar1.Text = System.IO.Path.GetFileName(m_mapDocumentName);
      }
    }
